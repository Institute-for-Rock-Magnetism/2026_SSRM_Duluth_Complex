#!/usr/bin/env python
"""Convert the D6A-AGT CIT-format demagnetization data to MagIC format.

This script reads the CIT files in this directory (the ``D6A-AGT.sam``
...
``D-6A_data/RAPID_SRM/MagIC_format/D6A-AGT``.

The conversion parameters are read from the ``D6A-AGT.inp`` file that
...
file:
    ...
    ./D6A-AGT.sam<tab>SO-V<tab>D6A-AGT<tab>5<tab>1<tab>True<tab>None<tab>0.0
...
INP_FILE = INPUT_DIR / "D6A-AGT.inp"
...
def main():
    """Run the CIT-to-MagIC conversion for D6A-AGT."""
