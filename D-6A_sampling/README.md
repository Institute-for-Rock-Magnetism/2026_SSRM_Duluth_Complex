...
Sample inventory and documentation for material collected from drill core D-6A at the Minnesota DNR Drill Core Library, May 26–28, 2026. Samples are keyed by footage (depth from collar) so they can be cross-referenced against the stratigraphic section and geochemistry in [`../D-6A_log/`](../D-6A_log/).
