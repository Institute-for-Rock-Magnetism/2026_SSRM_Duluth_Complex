...
| [software_setup/](software_setup/rockmagpy_setup.md) | Step-by-step guide to installing Python and RockmagPy on your own computer (Mac and Windows) and launching the RockmagPy notebooks |
